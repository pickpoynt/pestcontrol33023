...
import { ShieldCheck, Zap, Clock, Droplets, Waves, Phone, ChevronRight, Siren } from "lucide-react";
...
const Hero = ({
  ...
  subtitle = "West Bloomfield's elite incident response force. We provide rapid deployment of master-aligned mechanical units for surgical pipe stabilization and total hydraulic reset — 24/7. Reclaim your home's structural security today.",
  image = "/4.jpeg",
  overlayImage = "/1.jpeg",
  phone = "8777921410",
  badge = "WEST BLOOMFIELD PIPE FORCE",
  features = [
    { icon: Siren, text: "Rapid Incident Dispatch" },
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-slate-950">
      ...
      <div className="absolute inset-0">
        <img src={image} alt="Emergency Pipe Repair West Bloomfield" className="w-full h-full object-cover animate-slow-zoom" />
