...
import { ShieldCheck, Zap, Clock, Droplets, Waves, Phone, ChevronRight, MousePointer2 } from "lucide-react";
...
const Hero = ({
  ...
  subtitle = "South Brooksville's elite rodent containment force. We provide rapid deployment of master-aligned tactical units for surgical rodent neutralization and total structural reset — 24/7. Reclaim your home's security today.",
  image = "/4.jpeg",
  overlayImage = "/1.jpeg",
  phone = "3238801224",
  badge = "SOUTH BROOKSVILLE RODENT FORCE",
  features = [
    { icon: MousePointer2, text: "Rapid Rodent Neutralization" },
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-slate-950">
      ...
      <div className="absolute inset-0">
        <img src={image} alt="Rodent Control South Brooksville" className="w-full h-full object-cover animate-slow-zoom" />
