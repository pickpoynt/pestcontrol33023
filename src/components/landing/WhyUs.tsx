  ...
  const features = [
    {
      ...
      description: "When hot water fails in West Bloomfield, delay is not an option. Our specialists provide zero-latency deployment to stabilize your home's thermal comfort."
    },
    {
      icon: Shield,
      title: "Master-Aligned Setup",
      description: "We focus on surgical mechanical and material alignment designed to restore the thermal lifecycle of every West Bloomfield unit."
    },
    {
      icon: Zap,
      title: "Infinite Reset",
      description: "We don't just 'repair'; we modernize your home's thermal biology to ensure a permanent reset of your heating health."
    },
    {
      icon: Award,
      title: "West Bloomfield Master Force",
      description: "Licensed technicians who understand West Bloomfield's unique infrastructure and pressure shifts, providing highly surgical mechanical interventions 24/7."
    }
  ];
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2">
            ...
            <p className="text-xl text-slate-600 mb-10 leading-relaxed font-medium italic">
              Upgrading to tankless technology in West Bloomfield, MI is a structural and technological modernization. Conventional plumbers often provide antiquated hardware, but our West Bloomfield force uses 'Surgical Mechanical Force' to provide a total structural reset of your home's thermal biology. In the 48323 and 48324 zip codes, we are the first choice for permanent heat security. We protect your architectural envelope with master-aligned technical precision.
            </p>
          ...
          <div className="lg:w-1/2 relative space-y-4">
            <div className="grid grid-cols-2 gap-4">
                ...
                <img src="/3.jpeg" alt="MI Thermal Specialists" className="rounded-3xl shadow-2xl h-64 w-full object-cover -mt-8 border-2 border-white" />
                <img src="/4.jpeg" alt="Structural Heat Reset" className="rounded-3xl shadow-2xl h-64 w-full object-cover border-2 border-white" />
            </div>
