        ...
        <div className="flex flex-wrap justify-center gap-12">
          {links.map((link, index) => (
            <a 
              ...
              className="text-slate-500 hover:text-red-600 font-black text-xs uppercase tracking-[0.2em] transition-all flex items-center gap-3 border-b-2 border-transparent hover:border-red-600/50 pb-2 italic group leading-none"
            >
