        ...
        <footer className="bg-slate-950 text-white pt-24 pb-12 relative overflow-hidden border-t border-white/5">
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
                    ...
                    <div>
                        <h4 className="font-black text-white mb-8 uppercase tracking-[0.2em] text-xs underline decoration-red-600/50 underline-offset-8 leading-none">Quick Navigation</h4>
                        <ul className="space-y-4">
                            {["Services", "Why Us", "Infestation FAQ", "Contact"].map((item) => (
                                <li key={item}>
                                    <a href={`#${item.toLowerCase().replace(" ", "-")}`} className="text-slate-400 hover:text-red-500 transition-colors font-black uppercase tracking-widest text-[10px] flex items-center gap-3 group leading-none">
                    ...
                    <div>
                        <h4 className="font-black text-white mb-8 uppercase tracking-[0.2em] text-xs underline decoration-red-600/50 underline-offset-8 leading-none">Biological Nodes</h4>
                    ...
                    <div>
                        <h4 className="font-black text-white mb-8 uppercase tracking-[0.2em] text-xs underline decoration-red-600/50 underline-offset-8 leading-none">Support & Leasing</h4>
                        <div className="inline-flex items-center gap-3 group px-6 py-4 rounded-2xl bg-white/5 border border-white/10 hover:border-red-500/30 transition-all cursor-pointer shadow-xl">
                            ...
                            <a href="/lease-my-number" className="text-xs font-black uppercase tracking-widest text-slate-200 group-hover:text-white transition-colors leading-none">
                                Lease My Number
                            </a>
                ...
                <div className="pt-12 border-t border-white/5 space-y-12">
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 items-center">
                        ...
                        <div className="text-center md:text-left">
                            ...
                            <p className="text-slate-300 font-black text-sm uppercase italic tracking-tight leading-none">33023 Pest Force, Miramar, FL 33023</p>
                        </div>
                    </div>
