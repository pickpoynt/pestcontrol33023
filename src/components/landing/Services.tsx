...
const services = [
  {
    title: "Gas Tankless Integration",
    description: "Industrial-grade gas component deployment utilizing surgical ignition protocols to ensure infinite thermal efficiency in West Bloomfield residencies.",
    image: "/2.jpeg",
    points: ["Thermal Sync", "Vent Audit", "Flow Reset"]
  },
  {
    title: "Electric Unit Reset",
    description: "Reclaiming structural heat biology for high-efficiency electric heating units to restore vertical thermal distribution across your West Bloomfield architectural envelope.",
    image: "/3.jpeg",
    points: ["Circuitry Profiling", "Node Sync", "Vertical Reclamation"]
  },
  {
    title: "Hybrid Asset Upgrades",
    description: "Modern high-velocity asset hardening for aging West Bloomfield properties, replacing antiquated tanks with infinite thermal units.",
    image: "/1.jpeg",
    points: ["Asset Reset", "Heat Profilometry", "Structural Alignment"]
  },
  {
    title: "24/7 Thermal Emergency",
    description: "Rapid deployment of mechanical dispatch units to mitigate catastrophic heater failures during West Bloomfield's critical weather nodes.",
    image: "/4.jpeg",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-xl text-slate-600 font-medium italic">
            Expanding your home's thermal capacity in West Bloomfield requires master-aligned technical precision. We provide infinite hot water for every unit.
          </p>
        </div>
