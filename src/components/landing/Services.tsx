    ...
    <section id="services" className="py-24 bg-white relative overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-20 space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-600/10 text-red-600 mb-4 font-black uppercase tracking-widest text-xs leading-none">
              ...
              <div className="p-10 flex flex-col flex-grow">
                ...
                <div className="pt-8 border-t border-slate-200">
                  <a href="tel:3238801224" className="flex items-center justify-between w-full text-slate-950 hover:text-red-600 transition-colors">
                    <span className="font-black uppercase tracking-widest text-xs leading-none">Deploy Unit Now</span>
