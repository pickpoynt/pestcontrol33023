                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-3">
                            {["19601", "19604", "19606", "19607"].map((zip) => (
                ...
                <div className="pt-12 border-t border-white/5 space-y-12">
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 items-center">
                        <div className="flex flex-col gap-3">
                            <p className="text-slate-600 text-[10px] font-black uppercase tracking-[0.3em] leading-none italic">Primary Contact Node</p>
                            <a href="tel:8777921410" className="text-4xl font-black text-white hover:text-red-500 transition-colors tracking-tighter leading-none italic">
                                (877) 792-1410
                            </a>
                        </div>
                    ...
                    <div className="bg-white/5 p-10 shadow-2xl relative overflow-hidden border border-white/10">
                        ...
                        <p className="text-slate-500 text-[11px] leading-relaxed font-black italic text-center uppercase tracking-tighter">
                            <span className="text-slate-300 font-black block mb-4 uppercase tracking-[0.3em]">Architectural Notice & Disclaimer</span>
