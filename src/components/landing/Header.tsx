      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 group cursor-pointer">
            <div className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all duration-300 ${isScrolled ? "bg-red-600" : "bg-white/10 backdrop-blur-md border border-white/20 rotate-[-10deg] group-hover:rotate-0"}`}>
              <ShieldCheck className={`w-7 h-7 ${isScrolled ? "text-white" : "text-red-400"}`} />
            </div>
            <div>
              ...
              <span className={`text-sm font-bold uppercase tracking-[0.2em] ${isScrolled ? "text-red-600" : "text-red-400"}`}>
                Thermal <span className="text-[10px] opacity-70">Force</span>
              </span>
            </div>
          </div>
